<%@ Page Title="" Language="C#" MasterPageFile="~/yonetim/EnKa.master" AutoEventWireup="true" CodeFile="CariIslemDuzenle.aspx.cs" Inherits="yonetim_CariIslemDuzenle" %>
                ...
                <div class="col-lg-12">
                    <div class="p-3">
                        <div class="text-center">
                            <h1 class="h4 text-gray-900 mb-4">Cari İşlem Düzenle!</h1>
                        </div>                        
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <asp:Button ID="Button1" runat="server" class="btn btn-primary btn-user btn-block" Text="Düzenle" OnClick="Button1_Click" />
